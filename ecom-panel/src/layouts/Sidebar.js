    ...
    return (
        <div id="app-sidepanel" className="app-sidepanel">
            ...
            <div className="sidepanel-inner d-flex flex-column">
                <Link to="#" id="sidepanel-close" className="sidepanel-close d-xl-none">{" "}</Link>
                <div className="app-branding">
                    <Link className="app-logo" to="/"><img className="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo" /><span className="logo-text">PORTAL</span></Link>
                </div>
                ...
                <div className="app-sidepanel-footer">
                    <nav className="app-nav app-nav-footer">
                        <ul className="app-menu footer-menu list-unstyled">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to="https://themes.3rdwavemedia.com/bootstrap-templates/admin-dashboard/portal-free-bootstrap-admin-dashboard-template-for-developers/">
                                    <span className="nav-icon">
